...
public class Sistema {
    ...
    /**
     * Metodo para la verificar si el ususario existe en el sistema donde recorreremos el ArrayList Usuario
     * y ponemos una condicion si el usuaario ingresado es igual al usuario en el Array asi mismo con la contraseña
     * si entra a la condicion retornaremos la informacion del usuario de no ser asi devolvera null.
     * @param usuario
     * @param contrasenia
     * @return Usuario
     */
    ...
    /**
     * Metodo para agregar a todos los usuarios al ArrayList usuarios de la clase Usuario que se encuentran en el archivo usuarios.txt
     * leyendo por el metodo ManejoArchivos.LeeFichero el cual retornara una lista string por cada linea en el archivo, la cual se va recorrer
     * y obtener un String la cual la vamos a separar en una lista con "," donde vamos a poner una condicion para cliente y planificado donde vamos
     * a instanciar los dos tipos de usuarios debido a que algunos tienen mas indices que otro.
     * @return void
     */
